...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        names='class',
        title=f'Total Succss for Launch Site {entered_site}')
        return fig
...
def scatter(entered_site, payload):
    ...
    if entered_site == 'ALL': #return the outcomes for all sites as a scatter plot
        ...
        title=f"Success by Payload Mass and Booster Version for {entered_site}")
        return fig
